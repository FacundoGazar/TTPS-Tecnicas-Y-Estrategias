...
class AhoCorasick:
    def __init__(self, patterns):
        ...
        for key, child in list(self.root.children.items()):
        ...
        while i < len(text):
            ...
            if state.has_child(c):
                ...
                for val in state.outputs:
                    found.append({"pos": i - len(val), "val": val})
            else:
                i += 1
        return found